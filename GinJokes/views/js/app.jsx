...
class LoggedIn extends React.Component {
  ...
  componentDidMount() {
    this.serverRequest();
    //this.interval = setInterval(() => this.setState({ serverRequest() }), 1000);
  }
  ...
  serverRequest(joke) {
    $.post(
      ...
      res => {
        ...
        //this.setState({ likesCount: joke.likes});
      }
    );
    ...
    $.get("http://localhost:3000/api/jokes", res => {
      ...
      console.log(res);
      console.log(res[joke.id - 1]);
      //lastjoke = res[joke.id - 1];
    });

    console.log(window.location);
    window.location.reload();
    //console.log(test);
    //this.props.joke.likes=joke.likes+1;
    //this.props.joke=lastjoke;
  }

  componentDidMount() {
    this.interval = setInterval(() => window.location.reload(), 1000);
  }
